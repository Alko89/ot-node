...
module.exports = function(){
	return {
		parseGS1: function(gs1_xml_file) {
			parseString(gs1_xml_file, {explicitArray: false, mergeAttrs: true} , async function (err, result) {

				var gs1_xml = fs.readFileSync(gs1_xml_file, 'r');
